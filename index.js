...
function fixArtist (arr, index, name){
  arr[index].name = name;
  return arr[index];
}
console.log(fixArtist(artists, 8, "Vincent Van Gogh"));
...
*/
function removeArtist(arr, artist){
...
function addArtist(arr, id, name, years, genre, nationality, bio){
  ...
  console.log(addArtist(artists, 21, 'Emily Horne', '1994-Present', 'Cake Designer', 'Caucasian', 'Emily Horne is a remarkable cake decorater, a lover of hiking, a reader, and the best wife ever. She is currently a student a Lambda School as she is learning how to code. '));
